...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            string directoryPath = @"task1-5"; // Sets the directory path
            ...
            {
                if (fileName.Contains("Road") && fileName.EndsWith("256.txt")) // Checks if the file name contains "Road" and ends with "256.txt"
                {
                    ...
                    // Prints every 10th value in the array
                    Console.WriteLine();
